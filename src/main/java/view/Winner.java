...
public class Winner {
    ...
    public static void backstoryPane(Container pane) {
        ...
        ImageIcon banner = new ImageIcon(new ImageIcon("resources/millionaire.png").getImage().getScaledInstance(780, 150, Image.SCALE_AREA_AVERAGING));
        ...
        textArea.setText("You won! Your NetWorth is: " + player.getPrettyNetWorth());
        c.gridx = 0;
        c.gridy = 1;
        c.gridheight = 3;
        c.gridwidth = 1;
